...
import com.example.thenewsapp.adapter.NoteAdapter
import com.example.thenewsapp.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment(R.layout.fragment_home),SearchView.OnQueryTextListener, MenuProvider {
    ...
    private fun searchNote(query: String?){
        val seachQuery = "%$query"

        notesViewModel.seachNote(seachQuery).observe(this){list ->
